    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-500 font-sans selection:bg-emerald-500 selection:text-white">
      ...
      <div className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 text-[10px] font-black uppercase tracking-widest mb-8 border border-emerald-500/10">
            ...
            <h1 className="text-5xl md:text-8xl font-black text-slate-900 dark:text-white tracking-tighter leading-none mb-8 uppercase italic">
               Real Skills. <br />Real <span className="text-emerald-600">Proof.</span>
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-4">
               <Link to="/signup" className="px-10 py-4 bg-emerald-600 text-white rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-500/20 active:scale-95">
                  Get Started
               </Link>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
           <div className="p-10 rounded-[2.5rem] bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-white/5 transition-all hover:border-emerald-500/20">
              <ShieldCheckIcon className="w-10 h-10 text-emerald-600 mb-6" />
           ...
           <div className="p-10 rounded-[2.5rem] bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-white/5 transition-all hover:border-emerald-500/20">
              <ChatBubbleLeftRightIcon className="w-10 h-10 text-emerald-600 mb-6" />
           ...
           <div className="p-10 rounded-[2.5rem] bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-white/5 transition-all hover:border-emerald-500/20">
              <SparklesIcon className="w-10 h-10 text-emerald-600 mb-6" />
        ...
        <div className="mb-32">
           <div className="bg-slate-900 dark:bg-slate-950 rounded-[4rem] p-10 md:p-20 overflow-hidden relative border border-white/5">
              <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-600/10 blur-[100px] -translate-y-1/2 translate-x-1/2"></div>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 relative z-10">
                 {/* For Sellers */}
                 <div>
                    <span className="text-[10px] font-black text-emerald-400 uppercase tracking-[0.3em] mb-4 block">For Professionals</span>
                    <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-tighter italic leading-none mb-8">Grow Your <br /><span className="text-emerald-500">Business.</span></h2>
                       ...
                       {[
                         ...
                         { title: "Manage Orders", desc: "Keep track of everything in your dashboard." }
                          ...
                          <li key={idx} className="flex gap-4">
                             <div className="w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center flex-shrink-0 text-emerald-500 font-black text-[10px]">{idx + 1}</div>
                             <div>
                 ...
                 {/* For Buyers */}
                 <div>
                    <span className="text-[10px] font-black text-emerald-400 uppercase tracking-[0.3em] mb-4 block">For Seekers</span>
                    <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-tighter italic leading-none mb-8">Find What You <br /><span className="text-emerald-500">Need.</span></h2>
                    <ul className="space-y-6">
                       {[
        ...
        <div className="text-center py-20">
           <h2 className="text-4xl md:text-6xl font-black text-slate-900 dark:text-white uppercase tracking-tighter italic leading-none mb-10">
              Ready to <span className="text-emerald-600">Join?</span>
           </h2>
           <div className="flex justify-center gap-6">
              <Link to="/signup" className="text-[10px] font-black uppercase tracking-widest text-emerald-600 hover:underline">Create Account</Link>
              <span className="text-slate-200 dark:text-slate-800">|</span>
              <a href="https://wa.me/254712345678" className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-emerald-600 transition-colors">Support Hub</a>
           </div>
        </div>
      ...
      <footer className="py-20 border-t border-slate-100 dark:border-white/5 text-center bg-slate-50 dark:bg-slate-900/50">
         <div className="flex items-center justify-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-xl bg-emerald-600 flex items-center justify-center text-white font-black italic">F</div>

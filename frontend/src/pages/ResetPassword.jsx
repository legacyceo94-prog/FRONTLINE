        ...
        <div className="bg-white/70 dark:bg-slate-800/60 backdrop-blur-2xl rounded-[2.5rem] shadow-2xl border border-white/20 dark:border-slate-700/50 p-8 sm:p-12">
          {success ? (
            <div className="text-center py-8 animate-in fade-in zoom-in duration-500">
               ...
               <Link to="/login" className="text-sm font-black text-blue-600 uppercase tracking-widest hover:underline">
                 Manual Redirect
               </Link>
            </div>
          ) : (
            <>
              <div className="text-center mb-10">
                <div className="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mx-auto mb-6 rotate-3">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-4">
                  <div className="group relative">
                    ...
                    <div className="relative">
                      <input
                        ...
                        required
                        className="w-full pl-5 pr-12 py-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all font-bold"
                        placeholder="••••••••"
                        value={password}
                  ...
                  <div className="group">
                    ...
                    <input
                      type={showPassword ? "text" : "password"}
                      required
                      className="w-full px-5 py-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all font-bold"
                      placeholder="••••••••"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-5 bg-gradient-to-r from-blue-600 to-blue-400 text-white font-black uppercase tracking-[0.2em] text-xs rounded-2xl hover:scale-[1.02] active:scale-98 transition-all shadow-xl shadow-blue-500/20 disabled:opacity-50"
                >
